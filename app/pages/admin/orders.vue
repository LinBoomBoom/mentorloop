      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr v-for="o in orders" :key="o.id" class="border-b border-line last:border-0">
            ...
            <td class="p-3"><span class="chip" :class="o.status==='paid'?'tag-green':o.status==='refunded'?'tag-gold':'tag'">{{ statusText(o.status) }}</span></td>
      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          <tr v-for="s in subs" :key="s.id" class="border-b border-line last:border-0">
            ...
            <td class="p-3"><span class="chip" :class="s.status==='active'?'tag-green':'tag'">{{ s.status }}</span></td>
