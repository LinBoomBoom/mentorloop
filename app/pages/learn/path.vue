    ...
    <div v-else-if="plan" class="relative">
      ...
      <div v-for="(m, i) in plan.plan.milestones" :key="i" class="card p-5 reveal">
        <div class="flex items-center gap-3 mb-3">
          <span class="w-8 h-8 rounded-full bg-gradient-to-br from-brand-coral to-[#be185d] text-white flex items-center justify-center text-sm font-bold shrink-0">{{ i + 1 }}</span>
