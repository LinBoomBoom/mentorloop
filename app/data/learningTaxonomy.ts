...
export const LEARNING_TAXONOMY: Record<string, Track[]> = {
  frontend: [
    { id: 'fe-web', name: 'Web 开发工程师', color: '#ff5e7e', order: 0,
      ...
      techNames: ['JavaScript', '性能优化', 'React', 'CSS', 'Vue', 'TypeScript', '安全', '工程化', 'Web 基础', '网络'] },
    ...
    { id: 'fe-viz', name: '可视化 / 图形工程师（ECharts / D3 / WebGL）', color: '#d946ef', order: 6,
      ...
      techNames: ['D3', 'ECharts', 'WebGL', '性能优化', 'JavaScript', '可视化基础', '综合应用', 'CSS', '工程化', 'Web 基础', 'Canvas', 'React', '安全'] },
  ...
  backend: [
    ...
    { id: 'be-db', name: '数据库 / 存储工程师（MySQL / PostgreSQL / Redis / NoSQL）', color: '#3b82f6', order: 2,
      ...
      techNames: ['MySQL', 'PostgreSQL', 'NoSQL', '数据库原理', 'Redis', '系统设计', '综合应用', '微服务', '网络', '消息队列', 'Elasticsearch'] },
  ...
  ai: [
    ...
    { id: 'ai-infra', name: 'AI Infra / 推理优化工程师', color: '#6366f1', order: 1,
      ...
      techNames: ['推理与部署', 'Prompt 工程', '综合应用', '模型与训练', '评估与观测', 'RAG', 'Agent'] },
    ...
    { id: 'ai-algo', name: '算法工程师（CV / NLP / 推荐）', color: '#d946ef', order: 3,
      ...
      chapterSubtracks: ['cv', 'nlp', 'rec'], techNames: ['模型与训练', 'CV', '推理与部署', '综合应用', '评估与观测', 'Prompt 工程', '数据与标注', 'RAG', 'NLP', '推荐系统'] },
