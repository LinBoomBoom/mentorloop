...
> 生成时间：2026-09-09T15:21:26.028Z｜数据源：data/devmentor.db + app/data/learningTaxonomy.ts + app/data/techVocabulary.ts
...
| A2 | 题库实际标签 ⊆ techNames（无漏筛） | ❌ FAIL | 10 |
| A3 | tech 无脏值（全部命中受控词表） | ✅ PASS | 0 |
| A4 | 单一 tech 占比 ≤ 60%（本体标签 ≤95%） | ❌ FAIL | 3 |
| A5 | 内容覆盖度：每赛道 章节≥6 且 题目≥100（提示项） | ✅ PASS | 0 |
| A6 | seed 章节数 == DB 章节数 | ✅ PASS | 0 |
| A7 | subtrack 归属合法（题∈赛道 / 章∈模块并集） | ✅ PASS | 0 |
| A8 | 题面唯一 / 无跨模块重复 | ✅ PASS | 0 |
| A9 | tech ∈ 词表 ∧ 该赛道被允许 | ❌ FAIL | 6 |

### ❌ A2 · 题库实际标签 ⊆ techNames（无漏筛）

| 赛道 | 问题 |
|---|---|
| fe-app | 有题未声明：Web 基础、综合应用 |
| fe-native | 有题未声明：Web 基础 |
| fe-viz | 有题未声明：Vue |
| fe-desktop | 有题未声明：Web 基础、综合应用 |
| fe-mobile | 有题未声明：Web 基础 |
| fe-uniapp | 有题未声明：Web 基础 |
| be-data | 有题未声明：微服务、消息队列 |
| be-search | 有题未声明：MySQL、综合应用 |
| op-sec | 有题未声明：SRE |
| ai-edge | 有题未声明：RAG、模型与训练 |

### ❌ A4 · 单一 tech 占比 ≤ 60%（本体标签 ≤95%）

| 赛道 | 问题 |
|---|---|
| fe-viz | 「JavaScript」占 86/134 = 64%（限 60%） |
| be-db | 「MySQL」占 201/223 = 90%（限 60%） |
| ai-algo | 「模型与训练」占 85/134 = 63%（限 60%） |

### ❌ A9 · tech ∈ 词表 ∧ 该赛道被允许

| 赛道 | 问题 |
|---|---|
| fe-app | 「Web 基础」×19 不在该赛道允许词表内 |
| fe-native | 「Web 基础」×11 不在该赛道允许词表内 |
| fe-viz | 「Vue」×2 不在该赛道允许词表内 |
| fe-desktop | 「Web 基础」×5 不在该赛道允许词表内 |
| fe-uniapp | 「Web 基础」×1 不在该赛道允许词表内 |
| be-search | 「MySQL」×1 不在该赛道允许词表内 |
...
| frontend | fe-native (原生客户端工程师) | 7 | 130 | 8 | 工程化 32% |
| frontend | fe-viz (可视化 / 图形工程师（ECharts / D3 / WebGL）) | 9 | 134 | 8 | JavaScript 64% |
...
| ai | ai-algo (算法工程师（CV / NLP / 推荐）) | 14 | 134 | 7 | 模型与训练 63% |
